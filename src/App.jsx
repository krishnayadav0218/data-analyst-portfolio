...
import TechStackCard3D from './TechStackCard3D.jsx';
    ...
    <main data-theme={theme}>
      ...
      >
        <motion.div className="section-heading" variants={fadeUpVariant}>
          ...
          <h2>A 3D card built from the same stack it's showing off</h2>
          <p className="section-subtext">
            Drag to spin it, or let it auto-rotate — the front is the quick intro, the back is the toolkit
            (Python, SQL, Power BI, React, Node.js) plus the highlight numbers from above.
          </p>
        </motion.div>

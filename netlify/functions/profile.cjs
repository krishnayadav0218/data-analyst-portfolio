const profile = {
  ...
  focusAreas: [
    ...
    'Exploratory data analysis and insight storytelling',
    'SQL-based data extraction and reporting',
    'Machine learning prototypes and model evaluation',
    'Automation-minded analytics for client-facing teams',
  ],
  education: [
    {
  ...
  skills: {
    Languages: ['Python', 'SQL', 'Java', 'MySQL'],
    Analytics: ['Power BI', 'Tableau', 'MS Excel', 'Dashboard Design'],
    Libraries: ['Pandas', 'NumPy', 'Scikit-learn', 'Matplotlib', 'Seaborn', 'TensorFlow'],
    Databases: ['MySQL', 'NoSQL fundamentals'],
    Web: ['React.js', 'JavaScript', 'HTML', 'CSS', 'PHP'],
    AI: ['Machine Learning', 'Generative AI tools', 'Model Prototyping'],
  },
  certifications: [
    'Artificial Intelligence - IBM CEAIA1IN',
    'Machine Learning - IBM ML0101EN',
    'Python for Data Science - IBM PY0101EN',
    'Business Intelligence - IBM CEBIA1IN',
